...
impl<T: ?Sized> ExtractFromJs for T
where
    T: JSValue,
{
    fn label() -> &'static str {
...
impl<T: Sized> ExtractFromJs for Option<T>
where
    T: JSValue,
{
    fn label() -> &'static str {
...
impl JsObject {
    ...
    pub fn as_value<T>(&self) -> Result<T, NjError>
    where
        T: JSValue,
    {
