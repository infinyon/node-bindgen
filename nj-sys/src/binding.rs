...
fn bindgen_test_layout_napi_property_descriptor() {
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_property_descriptor>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).utf8name) as usize - ptr as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_napi_extended_error_info() {
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_extended_error_info>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).error_message) as usize - ptr as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_extended_error_info>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).engine_reserved) as usize - ptr as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_extended_error_info>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).engine_error_code) as usize - ptr as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_napi_node_version() {
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_node_version>::uninit();
            let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_napi_module() {
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_module>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).nm_version) as usize - ptr as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_module>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).nm_flags) as usize - ptr as usize
        },
        4usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_module>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).nm_filename) as usize - ptr as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_module>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).nm_register_func) as usize - ptr as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_module>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).nm_modname) as usize - ptr as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            let uninit = ::std::mem::MaybeUninit::<napi_module>::uninit();
            let ptr = uninit.as_ptr();
            ::std::ptr::addr_of!((*ptr).nm_priv) as usize - ptr as usize
        },
        32usize,
        concat!(
            "Offset of field: ",
