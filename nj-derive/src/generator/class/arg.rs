      ...
      //  .filter(|arg| !arg.is_callback())
        ...
        .map(|(i, arg)|  {
            ...
            match &arg.typ {
                ...
                FunctionArgType::Closure(_) => quote! { compile_error!("closure can't be used in constructor ")},
          //      FunctionArgType::JSCallback(_) => quote! { compile_error!("JsCallback can't be used in constructor")},
                FunctionArgType::Ref(_) => quote! { compile_error!("ref can't be used in constructor")}
            }
        });
